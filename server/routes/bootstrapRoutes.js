...
import { getDiscountSettings, getPaymentQr } from '../services/settingsService.js'
...
router.get('/', async (req, res, next) => {
  try {
    ...
    const [billDocs, depositDocs, userDocs, discountSettings, paymentQr] = await Promise.all([
